...
from src.data_modules.lusifer_datamodules import LusiferDataModule, get_dataloaders
...
from src.model.utils import get_wrapping_policy, get_activation_checkpointing_policy
...
def main(
    ...
    universal_learner_tokenizer = model.universal_learner_tokenizer
    ...
    train_dataloader = get_dataloaders(
        ...
        input_tokenizer=universal_learner_tokenizer,
        output_tokenizer=encoder_tokenizer,
        epoch=0,
    )
...
def setup(data_args: DataArguments, model_args: ModelArguments, training_args: TrainingArguments, run_name: str = None):
    ...
    train_data = LusiferDataModule(
        ...
        constrastive_training_only= not training_args.is_alignment,
